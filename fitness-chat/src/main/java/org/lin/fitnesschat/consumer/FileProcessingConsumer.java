package org.lin.fitnesschat.consumer;

import io.minio.errors.*;
import lombok.extern.slf4j.Slf4j;
import org.lin.fitnesschat.config.KafkaConfig;
import org.lin.fitnesschat.entity.FileProcessingTask;
import org.lin.fitnesschat.service.ParseService;
import org.lin.fitnesschat.service.VectorizationService;
...
public class FileProcessingConsumer {
    ...
    public void processTask(FileProcessingTask task) {
        ...
        log.info("文件权限信息: userId={}, isPublic={}",
                task.getUserId(), task.isPublic());
