...
import org.lin.fitnesschat.client.LlmClient;
...
public class ChatHandler {
    ...
    public void processMessage(String userId, String userMessage, WebSocketSession session) {
        ...
        try {
            ...
            logger.info("调用LLM API生成回复");
            llmClient.streamResponse(userMessage, context, history,
                    chunk -> {
                        // 累积响应内容
                    ...
                    () -> {
                        ...
                        if (responseBuilder != null) {
                            ...
                            logger.info("LLM响应流已完成，长度: {}", completeResponse.length());
